...
public class BluezService extends IntentService {
    ...
    public static final String EVENT_MOUSE = "com.hexad.bluezime.mouse";
    public static final String EVENT_MOUSE_X = "x";
    public static final String EVENT_MOUSE_Y = "y";
    public static final String EVENT_MOUSE_W = "w";
